...
const Pricing = ({ triggerToast, language }) => {
  const t = {
    en: {
      ...
      grade910F2: "AI Academic Companion",
      ...
      grade1112F3: "Adaptive Practice Queries",
